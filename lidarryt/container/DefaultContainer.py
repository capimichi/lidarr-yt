...
class DefaultContainer:
    ...
    def __init__(self):
        ...
        self._injector.binder.bind(ProxyHelper, ProxyHelper(enable_proxy, proxy))
        self._injector.binder.bind(LidarrFsHelper, LidarrFsHelper(lidarr_root_folder))
        self._injector.binder.bind(DownloadHelper, DownloadHelper(youtube_audio_quality, self.get(ProxyHelper)))
